...
import { defaultIconSize } from '../../components/Nav';
...
const Profile = () => {
    ...
    return (
        <>
            <div className='flex m-auto w-[200px] rounded-full border-8 border-primary'>
            ...
            <div className='md:flex justify-between mt-16 m-auto sm:grid grid-cols-1 md:grid-cols-2'>
                <div className='md:w-1/2 text-center col-span-1'>
                    <FaPhoneAlt size={sizeIconProfile} className='text-primary cursor-pointer flex m-auto mb-4'/>
                    <a className='no-underline text-5xl first-letter:text-center font-semibold' href="tel:+00 151515">0368159999</a>
                </div>
                <div className='md:w-1/2 text-center col-span-1 mt-8 md:mt-0'>
                    <FaGoogle size={sizeIconProfile} className='text-primary cursor-pointer flex m-auto mb-4'/>
                    <a className='no-underline text-5xl first-letter:text-center font-semibold' href="tel:+00 151515">dudoanjr@gmail.com</a>
                </div>
            </div>
